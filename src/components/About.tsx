          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="feature-card">
                ...
                <p className="text-3xl font-playfair font-bold text-primary mb-1">50+</p>
                <p className="text-sm text-muted-foreground">Premium Okusi</p>
              </div>
              <div className="feature-card">
              ...
              <div className="feature-card">
                ...
                <p className="text-2xl md:text-3xl font-playfair font-bold text-primary mb-1">★★★★★</p>
